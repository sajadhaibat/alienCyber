            ...
            <div class="row">
                ...
                <div class="col-8 offset-2">
                    <div class="single-features">
                        <div class="">
                        <img class="icon" src="{{ asset('scholarshipImages/'.$scholarship->file) }}">
                        </div>
                        <div class="title-extra" >
                            <h3><a href="{{ url('show_scholarship', $scholarship->id) }}">{{ $scholarship->headline }}</a></h3>
                            <div class="title-extra-icons" style="font-size: 12px !important; margin-top: -8px">
                              <span class="text-success"><b>{{ $scholarship->country}},</b></span>
                              <span class="text-success"><b>{{ $scholarship->degree }}</b></span>
                            </div>
                        </div>
                       <p> {!! substr( strip_tags($scholarship->content)  , 0 , 90) !!}</p>
                    </div>
                </div>
